...
@Component({
          ...
          <div class="header-content">
            <div class="title-section">
              ...
              <div class="header-text">
                ...
                <p>Gestión de centros médicos y establecimientos de salud</p>
              </div>
            </div>
            <button 
              class="btn btn-new"
          ...
          <table class="table modern-table">
            <thead>
              <tr>
                ...
                <th>
                  <div class="header-cell">
                    <span class="icon-centro-atencion">🏥</span>
                    Nombre
                  </div>
                </th>
                <th>
                ...
                <th>
                  <div class="header-cell">
                    <span class="icon-centro-atencion">🏙️</span>
                    Localidad
                  </div>
                </th>
                <th>
              ...
              >
                ...
                <td>
                  <div class="nombre-info">
                    <div class="avatar-centro-atencion">🏥</div>
  ...
  `,
  styles: [`
    /* Estilos modernos avanzados para Centros de Atención */
    .container-fluid {
      max-width: 1600px;
      margin: 0 auto;
    }
    ...
    .modern-header {
      background: linear-gradient(135deg, #4e73df 0%, #1cc88a 40%, #36b9cc 100%);
      border: none;
      padding: 2rem;
      position: relative;
      overflow: hidden;
    ...
    .table-row.selected {
      background: linear-gradient(135deg, #cce7ff 0%, #e1f5fe 100%);
    ...
    .coords-info {
      ...
      font-size: 0.8rem;
      font-weight: 500;
      box-shadow: 0 3px 10px rgba(54,185,204,0.3);
    }
