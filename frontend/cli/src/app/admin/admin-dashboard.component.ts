    ...
    <div class="admin-dashboard">
      ...
      <div class="quick-actions">
        ...
        <div class="section-title-container">
          <h2><i class="fas fa-lightning-bolt me-3"></i>Panel de Control</h2>
          <p class="section-description">
            Accede a las herramientas de administración del sistema
          </p>
        </div>
        <div class="actions-grid">
          <div class="action-card action-audit" (click)="goToAudit()">
            <div class="card-icon">
          ...
          <div class="action-card action-users" (click)="goToUsers()">
            <div class="card-icon">
          ...
          <div class="action-card action-reports" (click)="goToReports()">
            <div class="card-icon">
      ...
      <div class="system-status">
        ...
        <div class="status-grid">
          ...
          <div class="status-card status-users">
            <div class="status-icon">
