...
Característica: Gestión de Especialidades
  ...
  Esquema del escenario: Modificar una especialidad exitosamente
    ...
    Ejemplos:
      ...
      | Cardiología     | Diagnóstico y tratamiento de enfermedades del corazón y el sistema circulatorio. | Cardiología Avanzada | Especialidad avanzada en cardiología.       | 200         | Especialidad editada exitosamente    |
